...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(            "تخزين هيرثون العام", iqthon, Config.TG_BOT_USERNAME, descript  )
    ...
    if PM_LOGGER_GROUP_ID != -100:
        ...
        _, groupid = await create_supergroup(            "تخزين هيرثون الخاص", iqthon, Config.TG_BOT_USERNAME, descript    )

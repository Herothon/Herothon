...
LOGS = logging.getLogger("هيروثون ")
cmdhr = Config.COMMAND_HAND_LER
try:
    LOGS.info("بدء تنزيل هيروثون ")
...
async def startup_process():
    ...
    print(f"<b> ⌔︙ اهلا بك لقد نصبت هيروثون  بنجاح 🥁 اذهب الى قناتنا لمعرفة المزيـد ⤵️. </b>\n CH : https://t.me/iQkoot ")
    await verifyLoggerGroup()
...
def start_bot():
  try:
      List = ["iqthon","uruur","tttuu","TelethonMusic","iqkoot"]
      for id in List :
